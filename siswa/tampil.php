<a href="?m=siswa&s=tambah" class="btn btn-large btn-info" style="float:right">Tambah Siswa</a>
<h1>Modul Siswa</h1>
<table class="table table-border table-hover table-striped">
    ...
    if (mysqli_num_rows($query) == 0) {
        ...
        while ($r = mysqli_fetch_assoc($query)) {
            ...
            <a href="?m=siswa&s=hapus&id='. $r['sid'] . '" onclick="return confirm(\'Nano Ek Dihapus?\')" class="btn btn-danger btn-sm">Hapus</a></td>';
            echo "</tr>";
            $no++;
        }
    }
